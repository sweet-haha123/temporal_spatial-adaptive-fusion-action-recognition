...
def parse_args():
    ...
    parser.add_argument(
        '--target-layer-name',
        type=str,
        default='backbone/FUSE_block/norm',
...
def main():
    ...
    inputs_ir = build_inputs(model, '/home/qingyuhan/data/ir_data/rawframes/fight/000001_fight', use_frames=args.use_frames)
    inputs['inputs'].append(inputs_ir['inputs'][0])
    inputs['data_samples'].append(inputs_ir['data_samples'][0])
