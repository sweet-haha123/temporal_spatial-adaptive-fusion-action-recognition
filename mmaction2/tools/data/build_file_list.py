...
from tools.data.parse_file_list import (parse_directory, parse_diving48_splits,
                                        ...
                                        parse_ucf101_splits,
                                        parse_vis_data_splits,
                                        parse_ir_data_splits,
                                        )
...
def main():
    ...
    elif args.dataset == 'vis_data':
        splits = parse_vis_data_splits(args.level)
    elif args.dataset == 'ir_data':
        splits = parse_ir_data_splits(args.level)
