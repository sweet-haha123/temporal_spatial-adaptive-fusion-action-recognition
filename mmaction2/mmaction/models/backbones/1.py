...
if __name__=='__main__':
    model=SwinTransformer3D(patch_size=(2,4,4), drop_path_rate=0.2, time_pruning_loc=[0], time_left_ratio=[0.375], space_pruning_loc=[1],space_left_ratio=[0.6],time_score='tpool',space_score='spatch',pretrained2d=False)
