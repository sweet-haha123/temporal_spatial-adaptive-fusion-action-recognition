...
```shell
python tools/train.py configs/recognition/ntu_timesformer/timesformer_divST_8xb8-8x32x1-15e_kinetics400-rgb.py \
...
```shell
python tools/test.py configs/recognition/ntu_timesformer/timesformer_divST_8xb8-8x32x1-15e_kinetics400-rgb.py \
